...
public class TransactionEventProducer {
	...
	private Logger log = LoggerFactory.getLogger(TransactionEventProducer.class);
	@Autowired
	...
	public ListenableFuture<SendResult<Integer, String>> sendTransactionEvent(Operation payEvent)
			throws JsonProcessingException {
		Integer key = payEvent.getIdInvoice();
	...
	private ProducerRecord<Integer, String> buildProducerRecord(Integer key, String value, String topic) {
		List<Header> recordHeaders = List.of(new RecordHeader("transaction-event-source", "scanner".getBytes()));
